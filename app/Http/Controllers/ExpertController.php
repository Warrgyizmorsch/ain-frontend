...
class ExpertController extends Controller
{
    public function expert()
    {
        ...
        // $expert = Experts::all();
        $expert = Experts::paginate(8);
        return view('expert.new-expert-page', compact('data', 'expert'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if ($request->hasFile('photo')) {
                ...
                !empty($expert->image) && file_exists(public_path($expert->image)) &&
    ...
    public function expertProfile($slug)
    {
        ...
        return view('expert.new-expert-profile', compact('data', 'expert', 'customerReview', 'helpus', 'skills', 'totalReviews', 'averageRating'));
    }
