                    ...
                    <div class="chip" style="--d: 0ms">
                        <span class="chip__icon" aria-hidden="true">
                            <svg viewBox="0 0 24 24" width="18" height="18" fill="none">
                                ...
                                <path d="M8 13h8M8 17h6" stroke="currentColor" stroke-width="1.8"
                                    stroke-linecap="round" />
                            </svg>
                        </span>
                        <span class="chip__text">AI Free Content</span>
                    </div>

                    <div class="chip" style="--d: 90ms">
                        <span class="chip__icon" aria-hidden="true">
                            <svg viewBox="0 0 24 24" width="18" height="18" fill="none">
                                <path d="M4 12a8 8 0 0 1 16 0v6a3 3 0 0 1-3 3h-2" stroke="currentColor"
                                    stroke-width="1.8" stroke-linecap="round" />
                                <path d="M4 12v4a2 2 0 0 0 2 2h1v-8H6a2 2 0 0 0-2 2Z" stroke="currentColor"
                                    stroke-width="1.8" />
                                <path d="M20 12v4a2 2 0 0 1-2 2h-1v-8h1a2 2 0 0 1 2 2Z" stroke="currentColor"
                                    stroke-width="1.8" />
                            </svg>
                        </span>
                        <span class="chip__text">24/7 Live Support</span>
                    </div>

                    <div class="chip" style="--d: 180ms">
                        <span class="chip__icon" aria-hidden="true">
                            <svg viewBox="0 0 24 24" width="18" height="18" fill="none">
                                <path d="M12 3 20 7v6c0 5-3.2 8.6-8 10-4.8-1.4-8-5-8-10V7l8-4Z" stroke="currentColor"
                                    stroke-width="1.8" />
                                <path d="m9 12 2 2 4-5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                        </span>
                        <span class="chip__text">Plagiarism Free</span>
                    </div>
                </div>
            </div>
...
.chip__icon {
    ...
    width: 36px;
    height: 36px;
    background-color: white; /* Sirf circle white */
    border-radius: 50%;
    color: #333; /* Icon ka color dark taaki white pe dikhe */
    color:  #4F299F;
}
    </style>
</section>