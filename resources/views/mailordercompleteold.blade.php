													...
													<table class="heading_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-top:12px;text-align:center;width:100%;">
																<h1 style="margin: 0; color: #292929; direction: ltr; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 32px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 38.4px;"><span class="tinyMce-placeholder">Completed your Order !</span></h1>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-top:10px;">
																<div style="color:#101112;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">Dear <b> {{$OrderData['name']}} </b> <br> <br> Greetings of the day. I trust this message finds you well.
                                                                        &nbsp;<br><br>The purpose of this communication is to inform you that the current assignment titled <b>"{{$OrderData['title']}}"</b> with the order code <b>{{$OrderData['order_code']}}</b> , is now ready for your review. <br> <br>
                                                                        To proceed with the completion of the work, we kindly request the balance payment of <b> £{{$OrderData['due']}}</b>. <br> <br>
                                                                         Once the payment is received, we will promptly deliver the finalized assignment to you. <br> <br> Furthermore, upon receiving the work, if you have any specific adjustments or require modifications, please do not hesitate to inform us.  <br> <br>
                                                                          We are committed to providing the best possible solutions to meet your expectations.
                                                                          <br><br>
                                                                          Our primary objective is to ensure that you receive high-quality work, facilitating your pursuit of higher grades. Your satisfaction is of paramount importance to us.

                                                                        <br><br>
                                                                        Kindly arrange the balance payment at your earliest convenience, and if you have any queries or need further assistance, please feel free to reach out to us.
                                                                        <br><br>
                                                                        We appreciate your trust in our services and look forward to contributing to your academic success.
