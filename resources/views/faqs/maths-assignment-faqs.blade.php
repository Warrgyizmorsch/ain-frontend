...
<section class="faq-section bg-light">
    <div class="auto-container">
            ...
            <div class="title-column col-lg-12 col-md-12 col-sm-12">
                <div class="title-box text-center">
                    <h2 style="font-weight:500; font-size: 30px; color:black;" class="my-4">
                        <b>Frequently Asked Questions For {{$faq->name}}</b>
                    </h2>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            @php
                // Divide FAQs into two approximately equal columns
                $totalFAQs = count($faq->faqs);
                $halfFAQs = ceil($totalFAQs / 2); // First column gets one extra if odd

                $column1 = $faq->faqs->slice(0, $halfFAQs); // First half
                $column2 = $faq->faqs->slice($halfFAQs);   // Second half
            @endphp

            <!-- Column 1 -->
            <div class="col-lg-6 col-md-6 col-sm-12">
                <ul class="accordion-box">
                    @foreach($column1 as $index => $faqs)
                        <li class="accordion block">
                            <div class="acc-btn bg-white border" style="font-weight:500; font-size: 20px; color:black;">
                                Q {{ $loop->iteration }}: {{ $faqs->question }}
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <ul class="accordion-box">
                    @foreach($column2 as $index => $faqs)
                        <li class="accordion block">
                            <div class="acc-btn bg-white border" style="font-weight:500; font-size: 20px; color:black;">
                                Q {{ $loop->iteration + count($column1) }}: {{ $faqs->question }}
                                <div class="icon fa fa-angle-down"></div>
                            </div>
                            <div class="acc-content">
                                <div class="content">
