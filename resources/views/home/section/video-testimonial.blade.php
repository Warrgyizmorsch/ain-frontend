<section class="page-section reviews-section">
    <div class="container">
        <h2 class="section-title">Genuine Reviews From <span>Students Who Trust</span> Our UK Assignment Help</h2>
        <p class="reviews-subtitle">
            With an outstanding <a href="/review">4.4 average rating from over 5,126 reviews</a> across trusted platforms, students consistently choose Assignment In Need for reliable, fast, and high-quality academic help. See what they have to say:
                    ...
                    @foreach ($data['review'] ?? [] as $review)
                        <div class="slider-card">
                            ...
                            <div class="review-header">
                                ...
                                <span class="review-date">{{ \Carbon\Carbon::parse($review->submission_date)->format('F j, Y') }}</span>
                            </div>
                            <div class="stars">
                                @for ($i = 1; $i <= 5; $i++)
                            ...
                            @if(!empty($review->review_reply))
                                <div class="review-reply">
                                    <div class="reply-header">
                                        <img src="{{ asset('assets/media/layout/assignment_logo.webp') }}" alt="Company Logo" class="reply-logo">
                    ...
                    <div class="custom-slider-tracks" id="secondSliderTrack">
                        ...
                        <div class="slider-item">
                            <div class="chat-card">
                                ...
                                <p class="chat-review">
                                    “The experts guided me step by step and made graphs so easy to understand. Their help made my report clear and professional.”
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="slider-item">
                            <div class="chat-card">
                                ...
                                <p class="chat-review">
                                    “Assignment In Need saved my semester! Super-fast service and top-notch quality – highly recommended for students.”
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="slider-item">
                            <div class="chat-card">
                                ...
                                <p class="chat-review">
                                    “ I was panicking about my physics assignment, but Assignment In Need helped me last minute help”
                                </p>
                            </div>
                        </div>
                        <div class="slider-item"">
                            <div class="chat-card">
                                ...
                                <p class="chat-review">
                                    “  Got an A on my essay! Assignment In Need really helped me meet deadlines and made a tough week so much easier.”
                                </p>
                            </div>
                        </div>
                        <div class="slider-item">
                            <div class="chat-card">
                                ...
                                <p class="chat-review">
                                    “ They suggested great research sources and articles that perfectly fit my topic. Really helped me structure my work.”
                                </p>
                            </div>
                        </div>
                        <div class="slider-item">
                            <div class="chat-card">
                                ...
                                <p class="chat-review">
                                    “Assignment In Need has been a lifesaver! Their team is professional, delivers original work on time, and has helped me improve my grades with less stress.”
                                </p>
                            </div>
                        </div>
                    </div>
...
<style>
    ...
    .reply-author {
        font-weight: 600;
        color: #5e2ced; /* purple like your theme */
    }
    ...
    .reply-inline {
        display: inline;
        white-space: nowrap;   /* keeps text + Read More together */
    }
...
.slider-item {
  flex: 0 0 340px; /* each card is 300px wide */
}
</style>
