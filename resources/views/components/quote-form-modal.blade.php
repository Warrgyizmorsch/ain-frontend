...
<div class="quote-modal-overlay" id="quoteModalOverlay">
    ...
    <div class="quote-modal-content">
        ...
        <div class="mini-quote">
            ...
            <div class="mini-quote__layout">
                <div class="mini-quote__image">
                    <img src="{{ asset('images/popup.png') }}" alt="Assignment Help" loading="lazy">
                </div>

                <div class="mini-quote__content">
                    ...
                    <form id="quoteForm" class="mini-quote__form">
                        ...
                        <div class="mini-quote__grid">
                                ...
                                <div class="phone-field" id="phoneField">
                                    ...
                                    <div class="cc-menu" id="ccMenu">
                                        <div class="cc-search-wrap">
                                            <input type="text" id="ccSearch" class="cc-search"
                            ...
                            <div class="mini-field mini-field--pages">
                                ...
                                <div class="pages-stepper">
                                    ...
                                    <div class="pg-mid">
                                        <div class="pg-pages"><span id="pgVal">1</span> <span
                                                class="pg-muted">Pages</span>
                                        </div>
                                        <div class="pg-words"><span id="wordVal">250</span> <span
                                                class="pg-muted">words</span>
                                        </div>
                                    </div>
                        ...
                        <div class="mini-policy">
                            <label class="mini-check">
                                ...
                                <span class="mini-check__text">I agree with <a href="/PrivacyPolicy">Privacy Policy</a>
                                    & <a href="/Terms-Conditions">T&C</a>.</span>
                            </label>
                        </div>
...
<style>
    ...
    /* Layout with left image (desktop only) */
    .mini-quote__layout {
        display: flex;
        gap: 14px;
        align-items: center;
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function renderCountries(list = COUNTRIES) {
            ccList.innerHTML = list.map(c => `<div class="cc-item" data-name="${c.n.toLowerCase()}" data-iso="${c.i}" data-dial="${c.d}"><span>${getFlag(c.i)}</span><span>${c.n}</span><span style="margin-left:auto; font-weight:700;">${c.d}</span></div>`).join('');
        }
        ...
        function validatePayload(payload) {
            ...
            if (!payload.countryCode) { ok = false; setFieldError(document.getElementById('q_phone'), 'Country code is required.'); }
